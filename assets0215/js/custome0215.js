...
jQuery(document).ready(function ($) {
  ...
  function getTotal() {
    $.ajax({
      url: origin + "/static/DKSH/opb/search/search.php",
      type: "POST",
      dataType: "json",
      data: {
        action: "getTotal",
  ...
  function search0215() {
    ...
    $("#load-more-form-v1").click(function () {
      ...
      $.ajax({
        type: "GET",
        url: origin + "/static/DKSH/opb/form/form-more-v1.php",
        success: function (result) {
    ...
    $("#load-more-form-v2").click(function () {
      ...
      $.ajax({
        type: "GET",
        url: origin + "/static/DKSH/opb/form/form-more-v2.php",
        success: function (result) {
          $form_list.append(result);
        },
      }).always(function () {});
    ...
    $("#load-more-form-v3").click(function () {
      ...
      $.ajax({
        type: "GET",
        url: origin + "/static/DKSH/opb/form/form-more-v3.php",
        success: function (result) {
          $form_list.append(result);
        },
      }).always(function () {});
    ...
    $("#load-more-form-v4").click(function () {
      ...
      $.ajax({
        type: "GET",
        url: origin + "/static/DKSH/opb/form/form-more-v4.php",
        success: function (result) {
          $form_list.append(result);
        },
      }).always(function () {});
    ...
    $("#load-more-form-v5").click(function () {
      ...
      $.ajax({
        type: "GET",
        url: origin + "/static/DKSH/opb/form/form-more-v5.php",
        success: function (result) {
          $form_list.append(result);
        },
      }).always(function () {});
